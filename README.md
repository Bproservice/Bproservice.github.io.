                ...
                <div>
                    ...
                    <form>
                        <div>
                            ...
                            <input type="text" id="nom" name="nom" placeholder="Votre nom ou celui de la société">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" placeholder="Surface approximative, fréquence souhaitée, contraintes horaires…"></textarea>
                        </div>
                        <button type="button" class="btn btn-primary" onclick="alert('Formulaire visuel uniquement pour l’instant. Vous pouvez nous contacter par téléphone ou e-mail.');">
                            Envoyer ma demande
                        </button>
                    </form>
